...
func (*RoleMockClient) FindAll(_ context.Context, in *proto.FindAllRoleRequest, opts ...grpc.CallOption) (*proto.RolePaginationResponse, error) {
	return nil, nil
}
...
func (*RoleMockErrClient) FindAll(_ context.Context, in *proto.FindAllRoleRequest, opts ...grpc.CallOption) (*proto.RolePaginationResponse, error) {
	return nil, nil
}
